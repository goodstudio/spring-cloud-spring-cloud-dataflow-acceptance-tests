...
echo "*** SCHEDULES_ENABLED=$SCHEDULES_ENABLED"
echo "*** CF_SERVICE_SCHEDULER=$CF_SERVICE_SCHEDULER"
echo "*** SPRING_CLOUD_DATAFLOW_FEATURES_SCHEDULER_ENABLED=$SPRING_CLOUD_DATAFLOW_FEATURES_SCHEDULER_ENABLED"
